			...
			<div id="postbox-container-1" class="postbox-container">
				...
				<div class="meta-box-sortables">
					...
					<div class="postbox">
						...
						<h3><span><?php _e('Branches', 'revisr'); ?> <a id="new_branch" href="<?php echo get_admin_url(); ?>admin.php?page=revisr_branches" title="Manage Branches">(<?php _e( 'Manage', 'revisr' ); ?>)</a> </span></h3>
